        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            <div class="sticky-top">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="buku.php">
                    <div class="sidebar-brand-text fas fa-book"> Zidan_Perpus</div>
                </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- DataTales Example -->
                    <button style="margin-bottom:20px" type="button" class="btn btn-success col-md-2" data-bs-toggle="modal" data-bs-target="#myModal"><span class="glyphicon glyphicon-plus"></span><i class="fas fa-plus mr-2"></i>Tambah Buku</button>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <a title="hapus" class="btn btn-danger" href="deleteBuku.php?id=<?= $item['id_buku']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')"><i class="fas fa-trash"></i></a>&nbsp;
                                                </td>
                                            </tr>
                                                    ...
                                                    <div class="modal-content">
                                                        <form action="" method="post" enctype="multipart/form-data" class="mt-3 p-2">
                                                            ...
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Form Edit Buku - <?= $item['judul']; ?></h4>
                ...
                <form action="" method="post" enctype="multipart/form-data" class="mt-3 p-2">
                    ...
                    <div class="modal-body">
                        <div class="custom-css-form">
                            ...
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">ID Buku</label>
                                <input type="text" class="form-control" name="id_buku" id="id_buku" value="<?= $kodebuku; ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Penerbit</label>
                            <input type="text" class="form-control" name="penerbit" id="penerbit" placeholder="Pama Penerbit" required>
                        </div>
