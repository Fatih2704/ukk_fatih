...
<head>
  ...
  <link rel="icon" type="png" href="../images/perpus.png">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-success col-md-2"><span class="glyphicon glyphicon-plus"></span><i class="fas fa-plus mr-2"></i>Tambah Akun</button>
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-success">Daftar Akun</h6>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                          ...
                          <div class="modal-content">
                            <form method="post">
                              ...
                              <div class="modal-footer">
                                <button type="submit" class="btn btn-sm btn-success" name="update"><i class="fa fa-plus mr-2"></i>Save</button>
                    ...
                    if (isset($_POST['update'])) {
                      ...
                      $updatedata = mysqli_query($connection, "update user set username='$username', nama='$nama', password='$password', sebagai='$sebagai' where id='$id'");
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST">
                    ...
                    <div class="form-group">
                      <button type="submit" class="btn btn-sm btn-success" name="user"><i class="fa fa-plus"></i> Tambah</button>
