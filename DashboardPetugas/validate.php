          ...
          <div class="row">
            <div class="col-sm-8">
              <div class="card shadow">
                <div class="card-header">
                  <h6 class="m-0 font-weight-bold text-success">Detail Peminjaman Buku - <?php echo $item['judul']; ?></h6>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
            ...
            <div class="col-md-4">
              <div class="card card-success">
                <div class="card-header">
                  <center>
                    <h6 class="m-0 font-weight-bold text-success">Cover</h6>
                  </center>
                ...
                <div class="card-body">
                  ...
                  <h6 class="m-2 font-weight-bold text-center text-success">
                    <?php echo $item['judul']; ?>
                  </h6>
                </div>
              </div>
